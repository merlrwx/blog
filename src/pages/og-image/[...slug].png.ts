...
const RobotoMonoBold = fs.readFileSync(path.resolve("src/assets/roboto-mono-700.ttf"));
const RobotoMono = fs.readFileSync(path.resolve("src/assets/roboto-mono-regular.ttf"));
